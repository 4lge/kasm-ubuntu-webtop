...
RUN wget https://download1.rstudio.org/electron/jammy/amd64/rstudio-2026.05.0-218-amd64.deb && \
  dpkg -i rstudio-2026.05.0-218-amd64.deb || apt-get install -f -y
...
RUN wget https://downloads.vivaldi.com/stable/vivaldi-stable_8.0.4033.34-1_amd64.deb && \
  dpkg -i vivaldi-stable_8.0.4033.34-1_amd64.deb || apt-get install -f -y
