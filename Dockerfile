...
RUN wget https://github.com/quarto-dev/quarto-cli/releases/download/v1.10.3/quarto-1.10.3-linux-amd64.deb && \
  dpkg -i quarto-1.10.3-linux-amd64.deb || apt-get install -f -y
RUN wget https://downloads.vivaldi.com/stable/vivaldi-stable_7.9.3970.60-1_amd64.deb && \
  dpkg -i vivaldi-stable_7.9.3970.60-1_amd64.deb || apt-get install -f -y
