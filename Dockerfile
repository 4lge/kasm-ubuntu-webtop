FROM docker.io/kasmweb/ubuntu-noble-desktop:1.19.0-rolling-daily
USER root
...
RUN echo "y" | /usr/bin/unminimize || /bin true; perl -pi -e "s/Types: deb/Types: deb deb-src/" /etc/apt/sources.list.d/ubuntu.sources 
